...
public class LinkedPositionalList<E> implements PositionalList<E> {
  ...
  // index of given position p
  @Override
  public int indexOf(Position<E> p) throws IllegalStateException
  {
  	Node<E> node = validate(p);
  	int index = 0;
  	Node<E> iterator = header.getNext();
  	while(iterator.getElement() != node.getElement())
  	{
  ...
  public static void main(String[] arg)
  {
	  ...
	  Position<Integer> one,two,three;
	  one = list.addFirst(1);
	  two = list.addLast(2);
	  three = list.addLast(3);
	  System.out.println("index of 1:  "+ list.indexOf(one));
	  System.out.println("index of 2:  "+list.indexOf(two));
	  System.out.println("index of 3:  "+list.indexOf(three));
