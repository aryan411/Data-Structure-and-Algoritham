...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
  ...
  public static <E> void printPositionAndHeight(AbstractTree<E> t, Position<E> p) 
  {
	  for(Position<E> c: t.children(p) )
	  {
		  printPositionAndHeight(t,c);
	  }
	  System.out.println("Node : "+ p.getElement() + "\t Height of subtree: " + t.height(p));
  }
  public static <E> Position<E> preorderNextElement(AbstractTree<E> t,Position<E> P)
  {
	  List<Position<E>> tree =  (List<Position<E>>) t.preorder();
	  
	  if(tree.size() <= tree.indexOf(P)+1)
		  return new Node<E>(null,null,null,null);
...
//	  {
//		  pathLength += depth((Position<E>) tree.get(i));
//	  }
//	  return pathLength;
//  }
//  
...
//  
//	  System.out.println("\n Pth length of given tree is" + pathlength(lbt));
//  }
// 
